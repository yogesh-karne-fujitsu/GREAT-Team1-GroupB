...
CREATE TABLE `tblapprovers` (
  ...
  `approver_name` varchar(45) NOT NULL,
  `approver_mail` varchar(75) NOT NULL,
  PRIMARY KEY (`s_no`)
...
INSERT INTO `tblapprovers` VALUES (1,NULL,'Anandhan','anandhan.shanmugam@fujitsu.com'),(2,NULL,'Vishnu','vishnu.phad@fujitsu.com');
...
-- Dump completed on 2023-04-21 16:47:40
